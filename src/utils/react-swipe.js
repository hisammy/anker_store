(function (root, factory) {
  ...
  var ReactSwipe = React.createClass({
    ...
    componentDidUpdate: function (prevProps) {
      ...
      if(prevProps.children.length > this.props.children.length && this.swipe.getPos() > this.props.children.length - 1) {
        this.swipe.slide(this.props.children.length - 1, 400);
      }
